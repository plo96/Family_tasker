...
async def test_add_task(task_url: str, async_client: AsyncClient, new_task: TaskCreate):
    ...
    assert all(
        i in added_entity.__dict__.items() for i in new_task.model_dump().items()
    )


async def test_add_task_bad_name(
    task_url: str, async_client: AsyncClient, new_task_bad_name: dict
):
...
async def test_add_task_bad_description(
    task_url: str, async_client: AsyncClient, new_task_bad_description: dict
):
...
async def test_add_task_bad_price_min(
    task_url: str, async_client: AsyncClient, new_task_bad_price_min: dict
):
...
async def test_add_task_bad_price_max(
    task_url: str, async_client: AsyncClient, new_task_bad_price_max: dict
):
