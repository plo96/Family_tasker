...
async def test_patch_task_by_id(
...
async def test_patch_task_by_bad_id(
...
@pytest.mark.usefixtures("some_data_added")
async def test_patch_task_by_id_bad_name(
    task_url: str,
...
@pytest.mark.usefixtures("some_data_added")
async def test_patch_task_by_id_bad_price_min(
    task_url: str,
    async_client: AsyncClient,
    all_tasks_ids: list,
...
@pytest.mark.usefixtures("some_data_added")
async def test_patch_task_by_id_bad_price_max(
    task_url: str,
    async_client: AsyncClient,
    all_tasks_ids: list,
